...
"""
Returns number of frame skips, big frame skips (more than 10 frames) and maximum skipped time between frames (DATAIO)
"""
def get_frame_skips(data, println=False, skips='frame_dt'):
    frameskips = data[skips]
...
"""
Returns timestamp from session folder (DATAIO)
"""
